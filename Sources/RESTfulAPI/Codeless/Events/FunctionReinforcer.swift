...
//    
//    @objc public func dopamineTapReinforcement(reinforcedFunction: @escaping () -> Void) {
//        
//        
//        
//        
////        DopamineVersion.current.codelessReinforcementFor(sender: "UITapGestureRecognizer", target: NSStringFromClass(type(of: self)), selector: NSStringFromSelector(reinforcedFunction))  { reinforcement in
...
//}
//
//internal class FunctionReinforcer : NSObject {
//    
////    static let shared = FunctionReinforcer()
////
////
////    func attemptReinforcement(target: Any?, action: Selector?) {
////
////
