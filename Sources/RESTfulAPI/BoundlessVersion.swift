...
public class BoundlessVersion : UserDefaultsSingleton {
    ...
    public static var current: BoundlessVersion = {
        return UserDefaults.dopamine.unarchive() ?? BoundlessVersion.standard
        }()
        {
        didSet {
...
//            DopeLog.debug("Found BoundlessVersion saved in user defaults.")
            self.init(
                versionID: versionID,
                mappings: mappings,
...
//            DopeLog.debug("Invalid BoundlessVersion saved to user defaults.")
            return nil
        }
    }
...
//        DopeLog.debug("Saved BoundlessVersion to user defaults.")
    }
