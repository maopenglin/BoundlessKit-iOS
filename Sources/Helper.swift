...
//        }
    ...
    public static func logActionPairs(control: UIControl) {
        DopamineKit.debugLog(control.targetActionPairs().description)
    }
    
    public static func logControlActions(view: UIView) {
        for subview in view.subviews {
            if let control = subview as? UIControl {
                logActionPairs(control: control)
            } else {
                logControlActions(view: subview)
            }
        }
    }
}
