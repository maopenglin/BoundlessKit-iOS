...
//    static let reinforcementDecision = Expression<String>("reinforcementdecision")
    ...
    fileprivate static let tableQueue:DispatchQueue = DispatchQueue(label: "com.usedopamine.dopaminekit.datastore.ReinforcementDecisionsQueue", attributes: [])
...
//        }
    ...
    ///
    static func deleteAllFor (_ action: String) {
//        tableQueue.async {
//            guard let DB = SQLiteDataStore.sharedInstance.DDB else
//            {
//                DopamineKit.DebugLog("SQLite database never initialized.")
...
//        }
    ...
    ///
    static func findFirstFor(_ action: String) -> T? {
        var result:T?
//        tableQueue.sync {
//            guard let DB = SQLiteDataStore.sharedInstance.DDB else
//            {
...
//        }
    ...
    ///
    static func countFor(_ action: String) -> Int {
        var result = 0
//        tableQueue.sync {
//            guard let DB = SQLiteDataStore.sharedInstance.DDB else
//            {
